...
from data import SMPL_DATA,SMG_DATA,SMAL_DATA
...
if dataset_name =='SMPL-NPT':
    ...
    dataset = COMA_DATA(train=True, shuffle_point = shuffle_point, training_size = train_size)
